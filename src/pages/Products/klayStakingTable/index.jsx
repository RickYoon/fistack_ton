...
function KlayStakingTable({data, isLoading}) {
      ...
      <table class="w-full">
        ...
        <thead class="border-y border-gray-200 bg-white">
          <tr>
            ...
            <th class="bg-blue-gray-50/50 p-4">
              <p class="block antialiased font-sans text-sm text-blue-gray-900 font-normal leading-none opacity-70 text-right">Balance</p>
            </th>
          ...
          <tr class="border-b border-gray-100 cursor-pointer hover:bg-white hover:border border-gray-200" onClick={(e)=>{clickHandler(res.poolName, e)}}>
            ...
            <td className="p-4 text-right">
              <div className="">
                <div style={{fontSize:"15px", fontWeight:"500"}}>
                  {isLoading ? 
                    <ProductSkeleton style={{width:"60px", height:"20px"}}/> 
                    : res.investedKLAY === undefined ? 
                      <>-</>
                      :
