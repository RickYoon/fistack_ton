...
let iconUrl = {
  ...
  "STONFI": "https://img.cryptorank.io/coins/ston_fi1715854233885.png",
  "STORM": "https://icons.llamao.fi/icons/protocols/storm-trade?w=48&h=48"
}
...
function DetailStaking() {
  ...
  const [poolInfos, setPoolInfos] = useState([
    {
      ...
      "type": "Delta Neutral",
      "projectName": "StonFi + Storm Trade",
      "apr": 42.322
    }
  ])
  ...
  useEffect(() => {
    ...
    setLongAmount(depositAmount/7.2*(2/3))
  ...
  async function updateRatio(){
    ...
    if(depositAmount>0){
      ...
      tempRes["longUSDT"] = depositAmount * 2/3;
      tempRes["longTON"] = (depositAmount * 2/3 * oneTonPrice.askUnits)/(1e+9);

      tempRes["shortUSDT"] = depositAmount / 3;
      tempRes["shortTON"] = depositAmount / 3 * oneTonPrice.askUnits/(1e+9) * 2;
            ...
            <div style={{marginTop:"10px"}}></div>
              ...
              <div className="border border-gray-100 rounded-lg p-6 bg-white">
                <div className="grid grid-cols-3 gap-3 text-center text-sm">
                  ...
                  <p className="text-neutral-600 col-span-1">{balance.walletUSDT} USDT</p>
              ...
              <div className="border border-gray-100 rounded-lg p-5" style={{"backgroundColor":"white"}}>
                ...
                <div style={{marginBottom:"10px"}}>Investment Amount</div>
              ...
              <div className="border border-gray-200 rounded-lg pr-5 pb-5 mt-5 bg-gray-100">
                <div className="grid grid-cols-3 gap-3 text-center text-sm pt-5">
                 <p className="font-semibold col-span-1">Long</p>
                  <p className="font-neutral col-span-1">{afterSwap.longUSDT.toFixed(2)} USDT</p>
                  <p className="text-neutral-600 col-span-1">{afterSwap.longTON.toFixed(2)} TON</p>
                </div>   
                <div className="grid grid-cols-3 gap-3 text-center text-sm pt-5">
                 <p className="font-semibold col-span-1">Short</p>
                  <p className="font-neutral col-span-1">{afterSwap.shortUSDT.toFixed(2)} USDT</p>
                  <p className="text-neutral-600 col-span-1">{afterSwap.shortTON.toFixed(2)} TON</p>
                </div>   
                <div className="grid grid-cols-3 gap-3 text-left text-xs pl-10 pt-5">
                 <p className="font-semibold col-span-1"></p>
                 <p className="font-neutral col-span-1"></p>
                 <p className="font-neutral col-span-1">x2 leverage</p>
                </div>   
              </div>
            ...
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                            ...
                            <li>
                              {lpstate === 0 ?
                                ...
                                {/* <svg class="w-6 h-6 text-gray-800 dark:text-white mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                  ...
                                  Swap {afterSwap.longUSDT} USDT to {afterSwap.longTON.toFixed(5)} TON                                  
                                </div>
                                :
                            ...
                            <li>
                              {lpstate === 0 ?
                                ...
                                {/* <svg class="w-6 h-6 text-gray-800 dark:text-white mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                  ...
                                  Short {afterSwap.shortTON} TON with {afterSwap.shortUSDT} USDT             
                                </div>
                                :
                                <></>
                              }
                              ...
                              {lpstate === 2 ?
                                <div class="flex items-center p-3 text-base font-medium text-gray-900 bg-gray-200 rounded-lg border border-gray-200">
                                {/* <div class="w-6 h-6 ml-2">-</div> */}
                                <svg class="w-6 h-6 text-gray-800 dark:text-white mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
                                </svg>
                    ...
                    <div class="mt-3"></div>
                        ...
                        :
                        <button onClick={swapTrx} class="w-full items-center p-3 text-white font-bold text-gray-900 rounded-lg bg-primary-500 hover:bg-primary-700 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                            <div style={{textAlign:"center"}}>Short Position</div>
                        </button>              
                        }
...
const DeltaNeutralStrategy = () => {
  return (
    <div className="bg-white p-6 rounded-lg border border-gray-100 mx-auto">
      ...
      <p className="text-xm mb-2">
        Taking advantage of funding fee opportunities in <span className="font-bold">TON</span> <br/>
      </p>
      <div className="text-base bg-gray-100 p-4 rounded-lg shadow-inner mb-4">
